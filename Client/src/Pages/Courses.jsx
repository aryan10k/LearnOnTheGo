...
const Courses = () => {
  ...
  useEffect(()=> {
    const getAllPublishedCourse = async ()=> {
      try {
        const res = await axios.get(`https://learnonthego.onrender.com/api/v1/course/published-courses`, {withCredentials:true})
        if(res.data.success){
  ...
  return (
    <div className='bg-gray-100 pt-14'>
      <div className='min-h-screen max-w-7xl mx-auto py-10'>
        <div className='px-4'>
          <h1 className='text-4xl font-bold text-center text-green-700 mb-4'>Our Courses</h1>
