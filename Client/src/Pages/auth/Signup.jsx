...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        console.log(user)
        try {
            const response = await axios.post('https://learnonthego.onrender.com/api/v1/user/register', user, {
                headers:{
    ...
    return (
        <div className='flex justify-center items-center min-h-screen bg-gray-100'>
            <div className='bg-white shadow-lg rounded-lg p-8 max-w-md w-full'>
                ...
                <Button onClick={handleSubmit} className="w-full bg-green-600 hover:bg-green-800">Signup</Button>
                <p className='text-center mt-4'>Already have an account? <Link to="/login" className='text-green-500 hover:underline'>Log in</Link></p>
            </div>
        </div>
    )
}
