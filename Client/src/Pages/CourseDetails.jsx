...
const CourseDetails = () => {
    ...
    useEffect(()=> {
        const getCourseLecture = async()=> {
            try {
                const res = await axios.get(`https://learnonthego.onrender.com/api/v1/course/${courseId}/lecture`, {withCredentials:true})
                if(res.data.success){
                ...
                <div className='px-4 py-1'>
                    <div className='flex justify-between items-center'>
                        ...
                        <div className='flex space-x-4'>
                            <Button className="bg-green-600 hover:bg-green-900">Enroll Now</Button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='flex flex-col lg:flex-row lg:space-x-8'>
                        ...
                        <div>
                            ...
                            <ul className="mt-4 space-y-2">
                                <li className="text-gray-600">✔ Verified Teachers</li>
                    ...
                    courseLecture?.length == 0 ? null : <div className='flex flex-col md:flex-row justify-between gap-10 p-6'>
                        ...
                        <Card>
                            ...
                            <CardFooter className="flex p-4">
                              <Button className="bg-green-600 text-white shadow hover:bg-green-900">Learn Now</Button>
                            </CardFooter>
                        </Card>
                        </div>
                    </div>
                ...
                <div className='p-6'>
                    ...
                    <div className='flex items-center space-x-4'>
                        ...
                        <div>
                            ...
                            <p className='text-gray-600'>Verified Teacher</p>
                        </div>
                    </div>
